...
import { Trash2, Shield, Users, Plus } from "lucide-react";
...
export interface RoleManagementPanelRef {
  openCreateDialog: () => void;
}

export const RoleManagementPanel = forwardRef<RoleManagementPanelRef, RoleManagementPanelProps>(
  ({ initialRoles }, ref) => {
