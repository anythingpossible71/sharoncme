...
/**
 * Smaller variant of CrunchyCone logo for fixed header
 * Uses white text and smaller size while keeping dynamic scoop color
 */
export function CrunchyconeLogoFixed({
  className,
  ...
  return (
    <div className={`flex items-center gap-1.5 ${className}`}>
      <svg
        ...
        style={{
          // Use CSS variable for primary color directly
      ...
      <span className={`text-sm font-medium ${textColor}`}>Project Admin</span>
    </div>
  );
}
