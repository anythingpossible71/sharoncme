...
/**
 * Dynamic CrunchyCone logo that syncs ice cream scoop color with theme primary color
 * Uses CSS variable directly for perfect theme sync
 */
export function CrunchyconeLogo({ className }: { className?: string }) {
  return (
    <svg
      width="43"
      height="56"
