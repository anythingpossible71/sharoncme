...
**Important:** All platforms require both `AUTH_SECRET` and `NEXTAUTH_SECRET` environment variables with matching values for Auth.js v5 compatibility.
...
NEXTAUTH_SECRET=your-secure-random-secret-min-32-chars  # Must match AUTH_SECRET
...
- Ensure AUTH_SECRET and NEXTAUTH_SECRET are at least 32 characters long
- Verify both AUTH_SECRET and NEXTAUTH_SECRET have the same value
...
- Use secure, randomly generated AUTH_SECRET and NEXTAUTH_SECRET values (must match)
