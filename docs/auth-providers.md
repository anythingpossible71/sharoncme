...
This guide explains how to enable OAuth authentication providers in the CrunchyCone Vanilla Starter Project using Auth.js v5.
...
The application uses Auth.js v5 with dynamic provider configuration - OAuth providers are automatically enabled based on environment variables.
...
Google OAuth is already integrated into the application via Auth.js v5. You just need to configure the credentials and enable it.
...
GitHub OAuth is already integrated into the application via Auth.js v5. You just need to configure the credentials and enable it.
