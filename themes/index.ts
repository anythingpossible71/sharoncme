...
// Ice cream themes
import { strawberrySwirlTheme } from "./custom/strawberry-swirl";
import { sunsetSorbetTheme } from "./custom/sunset-sorbet";
import { lavenderHoneyTheme } from "./custom/lavender-honey";
import { matchaLatteTheme } from "./custom/matcha-latte";
import { blueberryCheesecakeTheme } from "./custom/blueberry-cheesecake";
import { rockyRoadTheme } from "./custom/rocky-road";
import { orangeCreamsicleTheme } from "./custom/orange-creamsicle";
import { caramelDrizzleTheme } from "./custom/caramel-drizzle";
import { cottonCandyTheme } from "./custom/cotton-candy";
import { birthdayCakeTheme } from "./custom/birthday-cake";
import { ubeTheme } from "./custom/ube";
import { lemonMeringueTheme } from "./custom/lemon-meringue";
import { pistachioAlmondTheme } from "./custom/pistachio-almond";
import { tuttiFruttiTheme } from "./custom/tutti-frutti";
import { electricMangoTheme } from "./custom/electric-mango";
import { raspberryRushTheme } from "./custom/raspberry-rush";
import { limeZingTheme } from "./custom/lime-zing";
import { grapeSodaTheme } from "./custom/grape-soda";
import { cherryBombTheme } from "./custom/cherry-bomb";
import { blueLagoonTheme } from "./custom/blue-lagoon";
import { superchargedOrangeTheme } from "./custom/supercharged-orange";
import { vividVioletTheme } from "./custom/vivid-violet";
import { kiwiSplashTheme } from "./custom/kiwi-splash";
import { passionFruitPunchTheme } from "./custom/passion-fruit-punch";
...
export const themes: ThemeRegistry = {
  ...
  "strawberry-swirl": strawberrySwirlTheme,
  "sunset-sorbet": sunsetSorbetTheme,
  "lavender-honey": lavenderHoneyTheme,
  "matcha-latte": matchaLatteTheme,
  "blueberry-cheesecake": blueberryCheesecakeTheme,
  "rocky-road": rockyRoadTheme,
  "orange-creamsicle": orangeCreamsicleTheme,
  "caramel-drizzle": caramelDrizzleTheme,
  "cotton-candy": cottonCandyTheme,
  "birthday-cake": birthdayCakeTheme,
  ube: ubeTheme,
  "lemon-meringue": lemonMeringueTheme,
  "pistachio-almond": pistachioAlmondTheme,
  "tutti-frutti": tuttiFruttiTheme,
  "electric-mango": electricMangoTheme,
  "raspberry-rush": raspberryRushTheme,
  "lime-zing": limeZingTheme,
  "grape-soda": grapeSodaTheme,
  "cherry-bomb": cherryBombTheme,
  "blue-lagoon": blueLagoonTheme,
  "supercharged-orange": superchargedOrangeTheme,
  "vivid-violet": vividVioletTheme,
  "kiwi-splash": kiwiSplashTheme,
  "passion-fruit-punch": passionFruitPunchTheme,
};
...
export {
  ...
  forestTheme,
  midnightTheme,
  strawberrySwirlTheme,
  sunsetSorbetTheme,
  lavenderHoneyTheme,
  matchaLatteTheme,
  blueberryCheesecakeTheme,
  rockyRoadTheme,
  orangeCreamsicleTheme,
  caramelDrizzleTheme,
  cottonCandyTheme,
  birthdayCakeTheme,
  ubeTheme,
  lemonMeringueTheme,
  pistachioAlmondTheme,
  tuttiFruttiTheme,
  electricMangoTheme,
  raspberryRushTheme,
  limeZingTheme,
  ...
  cherryBombTheme,
  blueLagoonTheme,
  superchargedOrangeTheme,
  vividVioletTheme,
  kiwiSplashTheme,
  passionFruitPunchTheme,
};
