...
import { CheckCircle, XCircle, Upload, Loader2, Copy, ExternalLink, Check, Edit } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="space-y-4">
        ...
        {/* Show URL and Edit button when complete, otherwise show build log */}
        {stage === 'complete' && outcome === 'success' ? (
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-card border border-border rounded-lg">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => window.open(`/admin/dev-publish-dialog?subdomain=${subdomain}`, '_blank')}
          ...
          >
            ...
            {(stage === 'building' || (stage === 'complete' && outcome !== 'success')) && (
              <>
