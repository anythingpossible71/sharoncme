    ...
    <div className="w-full max-w-lg min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div style={{ padding: '20px', paddingBottom: '100px' }}>
        ...
        <div className="space-y-6">
          ...
          />
          <p className="text-sm text-gray-600 dark:text-gray-400" style={{ marginTop: '12px' }}>
            <a 
              href="http://localhost:3000/admin/publish-settings" 
              className="text-blue-600 dark:text-blue-400 hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              To use an existing domain or purchase a new one go to publish settings
            </a>
          </p>
