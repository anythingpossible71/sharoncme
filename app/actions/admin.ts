...
export async function checkAdminExists(): Promise<boolean> {
  try {
    ...
    logger.error("Error checking admin existence", {}, error instanceof Error ? error : undefined);
...
export async function getDatabaseTables(): Promise<DatabaseTable[]> {
  ...
  try {
    ...
    logger.error("Error fetching database tables", {}, error instanceof Error ? error : undefined);
