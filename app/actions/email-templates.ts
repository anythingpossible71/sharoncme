...
import { getCurrentThemeEmailDesign, emailDesignToLiquidVars } from "@/lib/email/theme-mapping";
...
export async function renderTemplatePreview(
  ...
  try {
    ...
    try {
      ...
      // Get theme-based email design parameters
      const themeEmailDesign = await getCurrentThemeEmailDesign();
      const themeVars = emailDesignToLiquidVars(themeEmailDesign);

      // Merge theme variables with template data
      templateData = {
        ...templateData,
        ...themeVars,
      };
